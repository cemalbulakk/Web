    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var authManager = HttpContext.GetOwinContext().Authentication; //Uygulamadaki login işlemini yerine getirecek nesne
        ...
        [AllowAnonymous] // Login olmayan misafir kullanıcılar.
